...
//               className="col-span-1 border border-[#EBD08F] rounded-lg p-2 "
//               required
//             />
//             <input
//               type="email"
...
//               onChange={handleChange}
//               className="col-span-1 border border-[#EBD08F] p-2 rounded-lg"
//               required
//             />
//             <input
//               type="tel"
...
//               onChange={handleChange}
//               className="col-span-2 border border-[#EBD08F] p-2 rounded-lg h-24"
//               required
//             ></textarea>
//             <button
//               type="submit"
//               className="col-span-2 bg-[#B81626] font-serif text-white py-2 items-center text-center w-fit px-4 justify-center mx-auto rounded-full"
//             >
//               Book A Consultation
//             </button>
//           </form>
...
//               <button
//                 type="submit"
//                 className="bg-[#B81626] text-white py-2 font-serif items-center text-center justify-center mx-auto flex min-w-fit px-4 rounded-full"
//               >
//                 Book A Consultation
//               </button>
//             </form>
...
- Message: ${message}`;
  ...
  return (
    <div
      className="relative bg-[#F9EDB5] py-0 md:py-12"
      style={{ backgroundImage: "url('/assets/bookconsultationbackground.png')", backgroundSize: 'cover', backgroundPosition: 'center'  }}
    >
      {/* Desktop View */}
      <div className="hidden lg:block max-w-6xl mx-auto ">
        <h2 className="text-center text-4xl font-serif mb-6 ">BOOK YOUR CONSULTATION TODAY</h2>
        <p className="text-center font-sans text-xl mb-4 mx-[20%]">
          Take the first step toward a more harmonious and prosperous life. Contact us to schedule your personalized Numerology and Vastu consultation.
        </p>
        <p className="text-center text-red-700 text-xl mx-[20%] italic mb-10">
          The Path To True Happiness Starts With Self-Discovery. Take The First Step On Your Journey Today.
        </p>
        <div className="bg-[#F9EDB5] shadow p-8 rounded-3xl max-w-3xl mx-auto relative">
          <div className="text-2xl font-serif text-center items-center justify-center flex">
        ...
        <div
  className="text-center text-xl mx-[20%] mt-8 p-6 rounded-lg"
  style={{
  ...
  <p>
    Discover the science behind your success with The Numera Craft. Unlock your true potential today!
      ...
      <div className="lg:hidden p-6 relative">
        ...
        ></div>
        <div className="relative z-10">
          <h2 className="text-center text-3xl font-serif mb-6">BOOK YOUR CONSULTATION TODAY</h2>
          <p className="text-center text-sm mb-4">
            Take the first step toward a more harmonious and prosperous life. Contact us to schedule your personalized Numerology and Vastu consultation.
          </p>
          <p className="text-center text-red-500 italic mb-6">
        ...
        draggable="false"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <input
                ...
                value={formData.name}
                onChange={handleChange}
                className="w-full border border-[#EBD08F] p-2 rounded-lg"
                required
              />
              <input
                type="email"
              ...
              <textarea
                ...
                value={formData.message}
                onChange={handleChange}
                className="w-full border border-[#EBD08F] p-2 rounded-lg h-24"
                required
              ></textarea>
              <button
                type="submit"
                className="bg-[#B81626] text-white py-2 font-serif w-full text-center rounded-full"
              >
                Book A Consultation
              </button>
            </form>
